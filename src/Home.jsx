    ...
    return (
        <>
            ...
            <div>
                ...
                <div>
                    <Link className="link" style={{display: 'inline-block', border: '5px solid black', fontSize: '1.7em', color:"black", margin: '10px', padding: "10px", minWidth: '200px'}} to="/instructions">Play!   </Link>
                </div>
                <div>
                    <Link className="link" style={{display: 'inline-block', border: '5px solid black', fontSize: '1.7em', color:"black", margin: '10px', padding: "10px", minWidth: '200px'}} to="/leaderboard">Leaderboard   </Link>
                </div>
